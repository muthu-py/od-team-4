...
export default function ClassAdvisorRequestsTable({ requests, onApprove, onReject }) {
  // Debug the requests data
  console.log("Class Advisor Requests:", requests);

  return (
    <TableContainer component={Paper} elevation={3}>
      <Table sx={{ minWidth: 650 }} aria-label="class advisor requests table">
        <TableHead>
          ...
          {requests && requests.length > 0 ? (
            ...
            <TableRow>
              <TableCell colSpan={5} align="center">
                No pending requests from your class students
              </TableCell>
            </TableRow>
          )}
        </TableBody>
